  ...
  const shots = [
    {
      ...
      hardRules: 'STRICTLY NO HUMAN MODEL. MUST BE GHOST MANNEQUIN EFFECT (worn by invisible model). Maintain perfectly the original structure.',
    ...
    },
    {
      ...
      hardRules: 'STRICTLY NO HUMAN MODEL. MUST BE 3/4 SIDE ANGLE VIEW.',
    ...
    },
    {
      ...
      hardRules: 'STRICTLY NO HUMAN MODEL. MUST BE HANGING ON A RACK WITH BLURRED CLOTHES IN BACKGROUND.',
    ...
    },
    {
      ...
      positivePrompt: 'Extreme close-up macro detail shot of the {color} {product} fabric and texture. Focus on the material texture. Cinematic studio lighting, ultra sharp focus on the garment details.',
      negativePrompt: 'human, model, hanger, mannequin, full body',
      hardRules: 'STRICTLY NO HUMAN MODEL. MUST BE A CLOSE-UP MACRO SHOT.',
