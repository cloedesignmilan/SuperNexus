...
export default function RegistrazionePage() {
    ...
    const [planName, setPlanName] = useState("starter_pack");
    ...
    return (
        <div style={{minHeight: '100vh', background: '#0a0a0a', color: '#fff', padding: '40px 20px', fontFamily: 'Inter, sans-serif'}}>
            ...
            <style dangerouslySetInnerHTML={{__html: `
                ...
                input[value="starter_pack"]:checked + .radio-card { border-color: #ff0ab3 !important; background: rgba(255,10,179,0.05) !important; }
                input[value="retail_pack"]:checked + .radio-card { border-color: #00ffff !important; background: rgba(0,255,255,0.05) !important; }
                input[value="retail_monthly"]:checked + .radio-card { border-color: #ccff00 !important; background: rgba(204,255,0,0.05) !important; }
            `}} />
        </div>
    );
}
