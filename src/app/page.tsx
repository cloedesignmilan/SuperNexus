    ...
    <div className="landing-container">
      ...
      <section id="showcase" style={{ padding: '4rem 0', background: '#080808', color: '#fff', borderTop: '1px solid #222', borderBottom: '1px solid #222' }}>
        ...
        <div style={{ 
          ...
          {/* WOMEN */}
          <div className="macro-cat-icon">
            <div className="icon-circle" style={{ '--accent': '#a855f7' } as React.CSSProperties}>
          ...
          {/* MEN */}
          <div className="macro-cat-icon">
            <div className="icon-circle" style={{ '--accent': '#10b981' } as React.CSSProperties}>
          ...
          {/* T-SHIRTS */}
          <div className="macro-cat-icon">
            <div className="icon-circle" style={{ '--accent': '#3b82f6' } as React.CSSProperties}>
              <Shirt size={32} color="#3b82f6" />
            </div>
            <span>T-Shirts</span>
          </div>
          ...
          {/* FOOTWEAR */}
          <div className="macro-cat-icon">
            <div className="icon-circle" style={{ '--accent': '#f97316' } as React.CSSProperties}>
              <Footprints size={32} color="#f97316" />
            </div>
            <span>Footwear</span>
          </div>
          ...
          {/* BRIDAL */}
          <div className="macro-cat-icon">
            <div className="icon-circle" style={{ '--accent': '#f43f5e' } as React.CSSProperties}>
          ...
          {/* KIDS */}
          <div className="macro-cat-icon">
            <div className="icon-circle" style={{ '--accent': '#eab308' } as React.CSSProperties}>
              <Baby size={32} color="#eab308" />
            </div>
            <span>Kids</span>
          </div>
