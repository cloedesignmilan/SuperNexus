...
export const dictionaries = {
  en: {
    ...
    guestTryOut: {
      ...
      subtitle: "Upload a raw clothing photo and choose your style. We'll generate your first complete professional set (5 high-res images) completely free.",
      ...
      exhaustedDesc: "You have used your free generation. Create an account and upgrade to unlock unlimited access, higher resolution, and commercial rights.",
      registerBtn: "Register for Full Access",
      resetBtn: "Try another photo",
      generateBtnImages: "Generate 5 Images",
      trialText: "Trial",
      unlockTrialsTitle: "Unlock Your Free Set",
      unlockTrialsDesc: "Enter your email to instantly generate and save your 5 free AI images.",
      emailPlaceholder: "Your email address...",
      unlockingBtn: "Unlocking...",
      unlockBtn: "Create Account & Generate",
      noCreditCard: "No credit card required.",
      ...
      oneTrialRemaining: "Ready for your free set!",
      tryAnotherStyle: "Try Another Style",
      impressedTitle: "Impressed by the results?",
      impressedDesc: "You have used your free generation. Sign up to generate without watermarks, unlock 4K resolution, and access our API.",
  ...
  it: {
    ...
    guestTryOut: {
      title: "Vivi la Magia",
      subtitle: "Carica una foto e scegli il tuo stile. Genereremo il tuo primo set professionale completo (5 immagini) totalmente gratis.",
      ...
      exhaustedDesc: "Hai utilizzato la tua generazione gratuita. Crea un account e abbonati per sbloccare l'accesso illimitato, maggiore risoluzione e diritti commerciali.",
      registerBtn: "Registrati per l'Accesso Completo",
      resetBtn: "Prova un'altra foto",
      generateBtnImages: "Genera 5 Immagini",
      trialText: "Prova",
      unlockTrialsTitle: "Sblocca il tuo Set Gratuito",
      unlockTrialsDesc: "Inserisci la tua email per generare e salvare subito le tue 5 immagini IA gratuite.",
      emailPlaceholder: "Il tuo indirizzo email...",
      unlockingBtn: "Sblocco in corso...",
      unlockBtn: "Crea Account e Genera",
      noCreditCard: "Nessuna carta di credito richiesta.",
      ...
      oneTrialRemaining: "Pronto per il tuo set gratuito!",
      tryAnotherStyle: "Prova un altro stile",
      impressedTitle: "Impressionato dai risultati?",
      impressedDesc: "Hai utilizzato la tua generazione gratuita. Iscriviti per generare senza watermark, sbloccare la risoluzione 4K e accedere alla nostra API.",
