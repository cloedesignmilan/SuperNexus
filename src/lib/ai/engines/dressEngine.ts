...
${isOutfit ? `10. [STRICT APPAREL OUTFIT COORDINATION: The user has uploaded MULTIPLE separate garments (e.g., dress, shoes, jacket, bag). You MUST dress the model wearing ALL of these items together perfectly in the same image. Ensure precise, professional styling without merging the items. Do NOT mix up the items.]` : ''}
