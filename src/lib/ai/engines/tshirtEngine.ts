...
${isOutfit ? `10. [STRICT APPAREL OUTFIT COORDINATION: The user has uploaded MULTIPLE separate garments (e.g., top, bottom, shoes, jacket). You MUST dress the model wearing ALL of these items together perfectly in the same image. The model MUST wear the top on the upper body and the bottom (pants/skirt) on the lower body correctly. Ensure precise, professional styling without merging the items. Do NOT mix up the items.]` : ''}
