        ...
        <div className="chat-content">
          ...
          <div className="msg-row msg-user fade-in" style={{ animationDelay: '1s' }}>
            <div className="msg-bubble">
              <img src="/4-a.webp" alt="Foto scattata in negozio" className="msg-photo" loading="lazy" />
          ...
          <div className="msg-row msg-bot fade-in" style={{ animationDelay: '9s' }}>
            ...
            <div className="msg-bubble highlight-bubble">
              ...
              <img src="/4-b.webp" alt="Risultato editoriale" className="msg-photo-result" loading="lazy" />
          ...
          <div className="msg-row msg-user fade-in" style={{ animationDelay: '12s' }}>
            <div className="msg-bubble">
              <img src="/1-a.webp" alt="Seconda foto negozio" className="msg-photo" loading="lazy" />
          ...
          <div className="msg-row msg-bot fade-in" style={{ animationDelay: '20s' }}>
            ...
            <div className="msg-bubble highlight-bubble">
              ...
              <img src="/1-b.webp" alt="Risultato editoriale donna" className="msg-photo-result" style={{ width: '220px' }} loading="lazy" />
