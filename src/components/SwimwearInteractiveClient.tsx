          ...
          {activeModes.map((mode, i) => (
              <button 
                  ...
                  style={{ 
                      ...
                      width: '90px',
                      height: '90px',
                      background: validSelectedMode === mode.name ? 'linear-gradient(135deg, rgba(3,218,198,0.15) 0%, rgba(3,218,198,0.05) 100%)' : 'rgba(255,255,255,0.02)', 
                      border: validSelectedMode === mode.name ? '1px solid rgba(3,218,198,0.4)' : '1px solid rgba(255,255,255,0.05)', 
                      borderRadius: '16px', 
                      padding: '0.5rem',
                      textAlign: 'center', 
                      transition: 'all 0.3s ease', 
                      cursor: 'pointer',
                      boxShadow: validSelectedMode === mode.name ? '0 5px 15px rgba(3, 218, 198, 0.15)' : 'none'
                  }} 
                  className={validSelectedMode !== mode.name ? "hover-scale" : ""}
              >
                  <mode.icon size={24} style={{ marginBottom: '8px' }} color={validSelectedMode === mode.name ? "#03dac6" : "#888"} />
                  <span style={{ color: validSelectedMode === mode.name ? '#03dac6' : '#888', fontSize: '0.75rem', fontWeight: validSelectedMode === mode.name ? '700' : '500', transition: 'color 0.3s ease', lineHeight: 1.1 }}>{mode.name}</span>
              </button>
          ))}
