                      ...
                      <div>
                        ...
                        <div style={{ 
                          ...
                          {exampleData.afters.map((aImg: string, i: number) => (
                            <div key={i} style={{ position: 'relative', width: i === 0 ? '50%' : '100%', justifySelf: i === 0 ? 'center' : 'auto', height: i === 0 ? 'auto' : '250px', gridColumn: i === 0 ? '1 / -1' : 'auto', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 10px 30px rgba(0,0,0,0.5)', background: '#050505' }}>
